...
class HyperParams():
    ...
    Example:
    ```
    hyper_params = HyperParams(json_path)
    print(hyper_params.learning_rate)
    hyper_params.learning_rate = 0.5  # change the value of learning_rate in params
    ```
    """
    ...
    @property
    def dict(self):
        """Gives dict-like access to HyperParams instance by `params.dict['learning_rate']"""
